...
**Evergreen 2026-05-28+ (Round 2 6-person + 2026-05-29 user-directed 5-persona with prompt-mandated docs)**: See reliability-backlog.md:72 (EG Round 2) + new "User-Directed Evergreen Sweep" section (risk scream on Fidelity Contract:65-72 + FORBIDDEN:36-48, codebase map, simplifier dupe at gen:810-817 + legacy known:140 + install:33-37; 3 major shipped: H-GUARD-TRUTH-01 test-only live-pull, H-INSTALL-ROBUST-01 arg collapse + seam, docs overhaul per prompt mandate as authorized context; subagent overreach during discovery diagnosed + full revert to clean HEAD before TDD). 4 docs higher signal. H-FIDELITY-03 still requires waiver + 4-hardening. Docs win. Wubba lubba dub dub.
